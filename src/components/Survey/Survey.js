        ...
        return (
            <div className=".container">
                ...
                <select>
                                                ...
                                                {/* <i>Ice is great to have for flower, and makes your hit smoother.</i> */}
                                                <option value="choiceTwo">No, I prefer to not have an ice catcher</option>
                                                {/* <i>you dont want ice if this is a dab piece, the extract resolidify on cold surfaces, and you get less of your hit.</i> */}
                                            </select>
                                        </label>
                                    </div>
                                </div>
